...
import { createSecureNoteController, deleteSecureNoteController, getSecureNotes } from "../Controllers/secureNotesControllers.js";
...
secureNotesRouter.delete("/notes/:id", authValidation, deleteSecureNoteController);
